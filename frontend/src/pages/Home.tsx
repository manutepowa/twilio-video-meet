      ...
      <div className="flex flex-col">
        ...
        <form className="!appearance-none my-12 " >
          <span className='flex flex-row items-end'>
            ...
            <input type="text" value={path} onChange={(e) => setPath(e.target.value)} size={60} placeholder="Nombre de la sala" className="h-[48px] px-3 -mt-2 text-sm font-medium placeholder-opacity-50 transition duration-200  border-opacity-50 shadow-xl outline-none sm:px-2 bg-stone-50 text-stone-400 placeholder-stone-800 focus:placeholder-emerald-300 focus:border-emerald-400"/>
