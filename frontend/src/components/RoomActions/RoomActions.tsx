    ...
    <div className="absolute bottom-0 transform -translate-x-1/2 -translate-y-1/2 left-1/2">
      <div className="flex gap-1 bg-black rounded-md">
        <div className="action-buttons">
          <div className='p-0 m-0 tooltip'>
            <button type="button" onClick={() => localAudio.muteAudio()}>
              ...
              </button>{localAudio.audioSetting ? (<span className='tooltiptext'>Silenciar</span>) : (<span className='tooltiptext'>Activar</span>)}
          </div>
        ...
        <div className="action-buttons">
          ...
          </button>{localVideo.videoSetting ? (<span className='tooltiptext'>Apagar</span>) : (<span className='tooltiptext'>Encender</span>)}
          </div>
        </div>
        <div className="action-buttons">
          <div className='p-0 m-0 tooltip'>
